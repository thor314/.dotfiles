...
# rust wants this:
export PATH=$PATH:/home/thor/.cargo/bin


# racer wants this. Note that Racer wrongly thinks the end should be lib not library. Dummy.n
export RUST_SRC_PATH='/home/thor/.rustup/toolchains/nightly-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/library'

echo "reminder: PATH is $PATH"
...
alias eme="emacs -q -l .emacs.e/init.el"
